...
function useGameState () {
  ...
  // show new game on current game completion
  function newGame () {
  ...
  React.useEffect(() => {
    ...
    return (() => window.removeEventListener(function listeners (event) {
  ...
  return [state.board, state.moves, state.solved, newGame, move];
}
...
function App () {
  const [board, moves, solved, newGame,  move] = useGameState();
